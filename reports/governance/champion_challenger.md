...
|---|---|---|---|---|---|
| `naive1` | 0.1046 | +0.0160 | 6e-05 | 0.00036 | **SÍ** |
...
| retador | MASE media | margen vs campeón | Wilcoxon p | Holm p | ¿promovible? |
|---|---|---|---|---|---|
| `naive1` | 0.0773 | +0.0223 | 0.00195 | 0.00975 | **SÍ** |
| `median(sarima+ets+theta)` | 0.0856 | +0.0140 | 0.00195 | 0.00975 | **SÍ** |
| `ets` | 0.0915 | +0.0081 | 0.16016 | 0.39258 | no |
| `median(sarima+ets)` | 0.0942 | +0.0054 | 0.13086 | 0.39258 | no |
| `catboost` | 0.1051 | -0.0056 | 0.69531 | 0.69531 | no |
