...
| [`docs/RUNBOOK_PROPAGATION.md`](RUNBOOK_PROPAGATION.md) | canónico | el orden DATA → WEB → PROD, sus precondiciones, paradas, verificación y rollback | `tools/check_propagation.py` (`make propagate-check`) |
